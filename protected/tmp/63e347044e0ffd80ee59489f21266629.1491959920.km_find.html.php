<?php if(!class_exists("View", false)) exit("no direct access allowed");?><?php if (!empty($findone)) : ?>
<div style="float:right">
	<a href="<?php echo url(array('c'=>'kmblog/km', 'a'=>'update', 'id'=>$findone["article_id"], ));?>">修改内容</a>
</div>
